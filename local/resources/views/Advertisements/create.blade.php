    ...
    <div class="row">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-tag"></i>@lang('ads.addAdvertisement')
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form id="ads" method="POST" action="{{route('ads.store')}}"
                                    ...
                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0">
                                        <div class="col-md-12 ">
                                            ...
                                            <div class="col-md-12 input-group date" >
                                                <input type="text" size="16" name="start_publish" id="start_publish" class="form-control date-picker m-input" data-date-format="{{DATE_FORMAT}}" placeholder="@lang('ads.start_publish')">
                                            </div>
                                        ...
                                        <div class="col-md-12 ">
                                            <label for="publish_date"></label>
                                            <div class="col-md-12 input-group date" >
                                                <input type="text" size="16" name="end_publish" id="end_publish" class="form-control date-picker m-input" data-date-format="{{DATE_FORMAT}}"  placeholder="@lang('ads.end_publish')">
                                            </div>
...
@endsection
@section('scripts')
    @includeIf('Advertisements.scripts.create')
@endsection