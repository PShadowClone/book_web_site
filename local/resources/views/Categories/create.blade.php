    ...
    <div class="row">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-list"></i>@lang('category.addCategory')
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form id="category" method="POST" action="{{route('category.store')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3" style="text-align: center">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=@lang('category.no_image')"
                                                 alt=""/></div>
...
@endsection
@section('scripts')
    @includeIf('Categories.scripts.create')
@endsection