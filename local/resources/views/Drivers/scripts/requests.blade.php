<script>
    const LIBRARY_BASE_URL = '{{route('driver.request.show' , ['driver_id' => $driver->id])}}';
    var request_url = LIBRARY_BASE_URL;
...
<script>
    ...
    function drawRequestsDatatable(url) {
...
<script>
    // alert('dd');
    var datatable_requests = drawRequestsDatatable(request_url);
</script>
...
<script>
    ...
    * */
    $('#search').click(function () {
        ...
        var client = $('#request_client').val()
        var driver = $('#request_driver').val()
        var from = $('#request_from').val()
        var to = $('#request_to').val()
        request_url = request_url + "?status=" + status + "&request_identifier=" + request_identifier + "&client=" + client + "&driver=" + driver + "&from=" + from + '&to=' + to
        datatable_requests.ajax.url(request_url).load();
        request_url = LIBRARY_BASE_URL
