...
@section('breadcrumb')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>@lang('driver.driver')</span> : <span> {{$driver->name}}</span>
            </li>
        </ul>
    </div>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="padding:13px;margin-bottom: 15px">
                        <div class="col-md-12" style="text-align: center;padding: 15px;font-size: 17px">
                            <span class="">@lang('request.totalEvaluations')</span> : <span
                                    style="font-weight: bold"> {{number_format($driver['totalEvaluations'] , 2,'.',',') }} </span>
                            <input type="text" class="kv-gly-star rating-loading"
                                   value="{{$driver['totalEvaluations']}}" dir="rtl" data-size="xs" title="" disabled>
                        </div>
                        <div class="col-md-12">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" name="client_name" id="client_name"
                                       placeholder="@lang('request.client_name')"/>
                            </div>
                            <div class="col-md-3">
                                <input class="form-control" name="client_phone" id="client_phone"
                                       placeholder="@lang('request.client_phone')"/>
                            </div>
                            <div class="col-md-3">
                                <div class="input-group date-picker input-daterange" data-date="10/11/2012"
                                    ...
                                    <input type="text" class="form-control" name="from" id="from"
                                           placeholder="@lang('request.created_at')" style="text-align: right">
                                </div>
                            </div>
                        </div>
...
@endsection
@section('scripts')
    @includeIf('Drivers.scripts.evaluation')
