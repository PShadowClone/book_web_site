<script>
    ...
    * */
    ...
    /*
      *
      *    Global function to handel all web  success responses
      *
      * */
    function web_success(text, title, button) {
        toastr.options = {
            "closeButton": true,
            "debug": false,
     ...
     *
     * */
    function web_warnning(text, title, button) {
        toastr.options = {
            "closeButton": true,
            "debug": false,
            "positionClass": "toast-top-right",
    ...
    /**
     *
     *  Global function to handel all website error responses
     *
     *
     * */
    function web_error(text, title) {
        toastr.options = {
            "closeButton": true,
            "debug": false,
            "positionClass": "toast-top-right",
