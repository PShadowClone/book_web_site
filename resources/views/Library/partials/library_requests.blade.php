            ...
            <div class="row">
                ...
                <div class="col-md-12" style="padding:10px;margin-bottom: 15px">
                    ...
                    <div class="col-md-12" style="margin-top: 10px">
                        <div class="col-md-3">
                            <select name="request_status" id="status" class="bs-select form-control"
                        ...
                        <div class="col-md-6">
                            <div class="input-group date-picker input-daterange" data-date="10/11/2012"
                                ...
                                <input type="text" class="form-control" name="from" id="from" placeholder="@lang('request.created_at')">
                                <span class="input-group-addon"> @lang('request.to') </span>
                                <input type="text" class="form-control" name="to" id="to" placeholder="@lang('request.delivery_time')">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12" style="margin-top: 15px;text-align: left;padding-left: 30px">
                        ...
                        <span class="btn btn-default" name="cancel_search" id="cancel_search">@lang('lang.cancel')</span>
                    </div>
