...
return [
    ...
    'web' => [
        'promo_code_not_found' => 'البروموكود غير موجود',
        'promo_code_assigned_before' => 'الكود مضاف مسبقاً',
        'assigned_successfully' => 'تمت عملية الاضافة بنجاح',
        'assigned_error' => 'حدث خلل اثناء عملية الاضافة'
    ]
];