...
//Route::get('/login', ['as' => 'login', 'uses' => 'Login\Controller@index', 'prefix' => 'control']);
Route::get('/login', ['as' => 'login', 'uses' => 'auth\AdminController@attemptLogin', 'prefix' => 'control']);
Route::post('/forget/password', ['as' => 'forget.password', 'uses' => 'Login\ForgetPassword@sendEmail', 'prefix' => 'control']);
Route::post('/login', ['as' => 'login.check', 'middleware' => 'guest', 'uses' => 'Login\Controller@check', 'prefix' => 'control']);
Route::get('/reset/{email}/{token}', ['as' => 'password.reset.show', 'middleware' => 'guest', 'uses' => 'Login\ForgetPassword@showResetView', 'prefix' => 'control']);
Route::post('/reset/{email}/{token}', ['as' => 'password.reset', 'middleware' => 'guest', 'uses' => 'Login\ForgetPassword@reset', 'prefix' => 'control']);
/**
 *
 * Admin urls
 *
...
Route::group(['middleware' => ['web', 'auth'], 'prefix' => 'control'], function () {
...
Route::group([], function () {
    Route::get('/', ['as' => 'web.home.show', 'uses' => 'Home\WebController@show']);
    Route::get('/login', ['as' => 'web.login.show', 'uses' => 'Login\WebController@show']);
    Route::post('/login', ['as' => 'web.login.action', 'uses' => 'Login\WebController@login']);
    Route::get('/logout', ['as' => 'web.logout.action', 'uses' => 'Login\WebController@logout']);
    Route::get('/forget-password', ['as' => 'web.forget.password.show', 'uses' => 'Login\WebController@showForgottenPassword']);
    Route::get('/categories', ['as' => 'web.categories.show', 'uses' => 'Category\WebController@show']);
    Route::post('/forget-password', ['as' => 'web.forget.password.action', 'uses' => 'Login\WebController@forgetPasswordAction']);
    Route::get('/register', ['as' => 'web.register.show', 'uses' => 'Login\WebController@showRegister']);
    Route::post('/register', ['as' => 'web.register.action', 'uses' => 'Login\WebController@register']);
});
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::group(['prefix' => 'books', 'namespace' => '\Book'], function () {
        Route::get('/{id?}', ['as' => 'web.book.show', 'uses' => 'WebController@show'])->where(['id' => '[0-9]+']);
        Route::get('/search', ['as' => 'web.book.search.show', 'uses' => 'SearchController@search']);
    });

    Route::group(['prefix' => 'library', 'namespace' => '\Library'], function () {
        Route::get('/', ['as' => 'web.library.book.show', 'uses' => 'WebController@books']);
        Route::get('/nearest', ['as' => 'web.library.nearest.locations', 'uses' => 'WebController@nearestLibraries']);
    });

    Route::group(['prefix' => 'category', 'namespace' => '\Category'], function () {
        Route::get('/{id?}', ['as' => 'web.category.book.show', 'uses' => 'WebController@books']);
    });

    Route::group(['prefix' => 'cart', 'namespace' => '\Cart'], function () {
        Route::post('/', ['as' => 'ajax.web.cart.add', 'uses' => 'Controller@store', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
        Route::get('/', ['as' => 'web.cart.show', 'uses' => 'Controller@show', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
        Route::get('/delivery', ['as' => 'web.cart.delivery.show', 'uses' => 'Controller@showDelivery', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
    });

    Route::group(['prefix' => 'request', 'namespace' => '\Request'], function () {
        Route::delete('/{id?}', ['as' => 'ajax.web.request.delete', 'uses' => 'WebController@destroy', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
        Route::get('show/{id?}', ['as' => 'web.request.show', 'uses' => 'WebController@getRequestedBook', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
        Route::get('confirming', ['as' => 'ajax.web.request.confirm.request', 'uses' => 'WebController@sendConfirmingRequest', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
        Route::get('delivery/{request_id?}', ['as' => 'ajax.web.request.delivery', 'uses' => 'WebController@completeRequestsDelivery', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
        Route::put('/{id?}/{book_id?}', ['as' => 'web.request.update', 'uses' => 'WebController@update', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
    });

    Route::group(['prefix' => 'code', 'namespace' => '\Settings'], function () {
        Route::post('/', ['as' => 'web.code.store', 'uses' => 'WebPromocodeController@assign', 'middleware' => 'App\Http\Middleware\ClientMiddleware']);
